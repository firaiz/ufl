...
class HolidayTest extends TestCase
{
    ...
    protected function oneYear($year) {
        ...
        foreach ($holidays as $holiday) {
            $this->assertArrayHasKey($holiday->getDate(self::FORMAT), $lists);
            $this->assertEquals($holiday->getName(), $lists[$holiday->getDate(self::FORMAT)], $holiday->getDate(self::FORMAT));
        }
    }
