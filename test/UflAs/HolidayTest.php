...
class HolidayTest extends TestCase
{
    ...
    public function testAll()
    {
        foreach (range(2009, 2021) as $year) {
            ...
            foreach ($holidays as $holiday) {
                $this->assertArrayHasKey($holiday->getDate(self::FORMAT), $this->lists, $holiday->getDate(self::FORMAT));
                $this->assertEquals($holiday->getName(), $this->lists[$holiday->getDate(self::FORMAT)], $holiday->getDate(self::FORMAT));
            }
        }
    }
    ...
    public function testOneAt2014()
    {
        ...
        foreach ($holidays as $holiday) {
            $this->assertArrayHasKey($holiday->getDate(self::FORMAT), $this->lists);
            $this->assertEquals($holiday->getName(), $this->lists[$holiday->getDate(self::FORMAT)], $holiday->getDate(self::FORMAT));
        }
    }
